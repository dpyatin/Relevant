...
def getExcerpt(quote, image, title, author, tags):
	...
	passBook = quote + "+inline=" + title

	request = service.volumes().list(source='public', q=passBook)
	...
	for book in response.get('items', []):
		if(book['volumeInfo']['textSnippet'] is not None):
